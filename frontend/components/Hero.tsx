    ...
    <div className="relative h-screen w-full overflow-hidden bg-[#3E2723]">
      <div className="absolute inset-0 z-0">
        <video 
          ...
          poster="https://cdn.shopify.com/s/files/1/1707/3261/files/hp-poster.webp?v=1736778184"
        >
